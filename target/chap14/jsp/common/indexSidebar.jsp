...
<div class="nav" id="nav">
	<div class="t"></div>
   		<dl class="open">
	           ...
	           <dd><a href="${pageContext.request.contextPath}/claimVoucher/claimVoucher_list">查看报销单</a></dd>
	           <c:if test="${sessionScope.EMP.sysPositionByPositionId.nameCn eq '员工'}">
	           <dd><a href="${pageContext.request.contextPath}/claimVoucher/claimVoucher_edit">添加报销单</a></dd>
	           </c:if>
	       </dl>
       <dl>
       		<dt onclick="this.parentNode.className=this.parentNode.className=='open'?'':'open';">请假管理</dt>
	           <dd><a href="${pageContext.request.contextPath}/leave/leave_list">查看请假</a></dd>
		   		<c:if test="${sessionScope.EMP.sysPositionByPositionId.nameCn eq '员工'}">
		       <dd><a href="${pageContext.request.contextPath}/leave/leave_edit">申请请假</a></dd>
		       </c:if>
       </dl>

		   <c:if test="${sessionScope.EMP.sysPositionByPositionId.nameCn eq '部门经理'}">
       <dl>
		   ...
		   <c:if test="${sessionScope.EMP.sysPositionByPositionId.nameCn eq '总经理'||sessionScope.EMP.sysPositionByPositionId.nameCn eq '财务'}">
       <dl>
       		<dt onclick="this.parentNode.className=this.parentNode.className=='open'?'':'open';">统计报表</dt>
